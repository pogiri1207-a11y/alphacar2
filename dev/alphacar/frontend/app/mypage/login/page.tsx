...
function LoginContent() {
  ...
  const handleGoogleLogin = () => {
    ...
    const REDIRECT_URI = "https://fibrillose-madlyn-slaughteringly.ngrok-free.dev/mypage";
  ...
  const handleEmailLogin = async () => {
    ...
    try {
      const res = await fetch("https://fibrillose-madlyn-slaughteringly.ngrok-free.dev/auth/login", {
        method: "POST",
